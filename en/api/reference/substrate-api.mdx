...
<Warning>
  The Substrate API of SQD Network is currently in beta. Breaking changes may be
...
<Info>
  Contract addresses supplied with this data request must be hexadecimal (i.e.
  decoded from SS58) and lowecased. Addresses in all responses will be in the
  same format.
</Info>
...
<Info>
  Contract addresses supplied with this data request must be in lowercase.
  Addresses in all responses will be in the same format.
</Info>
