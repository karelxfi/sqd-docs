---
title: "Quickstart"
description: "Build your first blockchain indexer in 5 minutes with Squid SDK"
---

# Quickstart

This 5-minute tutorial shows you how to build an indexer using Squid SDK. You'll create a complete blockchain indexer that fetches, decodes, and serves USDC transfer data.

## What you'll build

Your indexer (squid) will:
...
<Check>
  Congratulations! You've successfully built and deployed your first blockchain
  indexer.
</Check>
