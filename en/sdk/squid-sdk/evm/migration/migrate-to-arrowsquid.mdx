...
```
We recommend using a private RPC endpoint for the best performance, e.g. from [BlastAPI](https://blastapi.io/). For squids deployed to [SQD Cloud](/en/cloud/overview/) you may also consider using our [RPC addon](/en/cloud/resources/rpc-proxy).
