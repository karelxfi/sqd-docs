...
- Make sure all the necessary fields are [indexed](sdk/reference/schema-file/indexes-and-constraints/). The best way to do that is to perform the [query optimization procedure](/en/cloud/resources/query-optimization/).
