---
title: "Run Squid Locally"
description: "Run squid processor and GraphQL server locally"
---

`sqd run`
=========

Run a squid locally according to the [deployment manifest](/en/cloud/reference/manifest).
