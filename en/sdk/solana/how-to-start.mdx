...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/en/sdk/solana/quickstart">
    Build your first Solana indexer in 5 minutes
  </Card>
  <Card
    title="Indexing Orca"
    icon="book"
    href="/en/sdk/solana/how-to-start/indexing-orca"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="terminal"
    href="/en/sdk/solana/how-to-start/cli-cheatsheet"
  >
    Quick reference for common commands
  </Card>
  <Card title="Solana API Reference" icon="code" href="/en/sdk/solana/sdk">
