...
Web-based monitoring dashboard for pipeline visualization.

```bash
npm install @sqd-pipes/pipe-ui
```

Provides real-time monitoring, metrics visualization, and profiling tools for your pipelines. See the [Quality of Life](/en/sdk/pipes-sdk/quality-of-life#pipeline-monitoring-ui) guide for usage examples.
