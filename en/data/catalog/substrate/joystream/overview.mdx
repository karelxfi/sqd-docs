...
```
https://v2.archive.subsquid.io/network/joystream
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/joystream")
...
Get started indexing Joystream data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/joystream/schema"
>
