...
```
https://v2.archive.subsquid.io/network/invarch-tinkernet
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/invarch-tinkernet")
...
Get started indexing Invarch Tinkernet data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/invarch-tinkernet/schema"
>
