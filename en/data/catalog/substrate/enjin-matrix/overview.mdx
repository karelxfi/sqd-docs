...
```
https://v2.archive.subsquid.io/network/enjin-matrix
```
...
Get started indexing Enjin Matrix data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/enjin-matrix/schema"
>
