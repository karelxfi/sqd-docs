...
```
https://v2.archive.subsquid.io/network/integritee
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/integritee")
...
Get started indexing Integritee Network data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/integritee/schema"
>
