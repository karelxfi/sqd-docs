...
```
https://v2.archive.subsquid.io/network/bridge-hub-rococo
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/bridge-hub-rococo")
...
Get started indexing Bridge Hub Rococo data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/bridge-hub-rococo/schema"
>
