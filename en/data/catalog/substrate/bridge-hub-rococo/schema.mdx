---
title: "Schema"
description: "Complete data schema and field reference for Bridge Hub Rococo"
---

# Bridge Hub Rococo Data Schema

Bridge Hub Rococo datasets provide comprehensive on-chain data indexed and queryable through the Subsquid Network.
