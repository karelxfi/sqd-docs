...
```
https://v2.archive.subsquid.io/network/polkadex
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/polkadex")
...
Get started indexing Polkadex data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/polkadex/schema"
>
