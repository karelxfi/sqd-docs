...
```
https://v2.archive.subsquid.io/network/darwinia-crab
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/darwinia-crab")
...
Get started indexing Darwinia Crab data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/darwinia-crab/schema"
>
