...
```
https://v2.archive.subsquid.io/network/bifrost-kusama
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/bifrost-kusama")
...
Get started indexing Bifrost Kusama data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/bifrost-kusama/schema"
>
