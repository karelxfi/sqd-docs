...
```
https://v2.archive.subsquid.io/network/interlay
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/interlay")
...
Get started indexing Interlay data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/interlay/schema"
>
