...
```
https://v2.archive.subsquid.io/network/basilisk
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/basilisk")
...
Get started indexing Basilisk data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/basilisk/schema"
>
