...
```
https://v2.archive.subsquid.io/network/acurast-canary
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/acurast-canary")
...
Get started indexing Acurast Canary data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/acurast-canary/schema"
>
