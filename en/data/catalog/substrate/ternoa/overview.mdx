...
```
https://v2.archive.subsquid.io/network/ternoa
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/ternoa")
...
Get started indexing Ternoa data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/ternoa/schema"
>
