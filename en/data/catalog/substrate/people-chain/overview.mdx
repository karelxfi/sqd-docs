...
```
https://v2.archive.subsquid.io/network/people-chain
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/people-chain")
...
Get started indexing People Chain data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/people-chain/schema"
>
