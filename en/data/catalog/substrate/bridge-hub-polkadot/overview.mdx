...
- **Network ID**: `bridge-hub-polkadot`
...
```
https://v2.archive.subsquid.io/network/bridge-hub-polkadot
```
...
Get started indexing Bridge Hub Polkadot data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/bridge-hub-polkadot/schema"
>
