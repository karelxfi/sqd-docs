...
```
https://v2.archive.subsquid.io/network/amplitude
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/amplitude")
...
Get started indexing Amplitude data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/amplitude/schema"
>
