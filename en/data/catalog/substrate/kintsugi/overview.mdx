...
```
https://v2.archive.subsquid.io/network/kintsugi
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/kintsugi")
...
Get started indexing Kintsugi data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/kintsugi/schema"
>
