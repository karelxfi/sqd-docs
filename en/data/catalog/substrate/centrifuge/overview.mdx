...
```
https://v2.archive.subsquid.io/network/centrifuge
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/centrifuge")
...
Get started indexing Centrifuge data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/centrifuge/schema"
>
