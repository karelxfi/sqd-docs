...
```
https://v2.archive.subsquid.io/network/turing-mainnet
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/turing-mainnet")
...
Get started indexing Turing data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/turing-mainnet/schema"
>
