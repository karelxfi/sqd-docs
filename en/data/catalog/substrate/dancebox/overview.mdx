...
```
https://v2.archive.subsquid.io/network/dancebox
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/dancebox")
...
Get started indexing Dancebox data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/dancebox/schema"
>
