---
title: "Overview"
description: "Shibuya data indexing and API access"
---
...
Get started indexing Shibuya data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/shibuya-substrate/schema"
>
