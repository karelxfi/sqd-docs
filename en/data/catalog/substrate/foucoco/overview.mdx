...
```
https://v2.archive.subsquid.io/network/foucoco
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/foucoco")
...
Get started indexing Foucoco data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/foucoco/schema"
>
