...
```
https://v2.archive.subsquid.io/network/zeitgeist-testnet
```
...
Get started indexing Zeitgeist Testnet data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/zeitgeist-testnet/schema"
>
