...
```
https://v2.archive.subsquid.io/network/equilibrium
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/equilibrium")
...
Get started indexing Equilibrium data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/equilibrium/schema"
>
