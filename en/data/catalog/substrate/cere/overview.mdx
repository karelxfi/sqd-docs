...
```
https://v2.archive.subsquid.io/network/cere
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/cere")
...
Get started indexing Cere data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/cere/schema"
>
