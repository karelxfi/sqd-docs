...
```
https://v2.archive.subsquid.io/network/polymesh
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/polymesh")
...
Get started indexing Polymesh data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/polymesh/schema"
>
