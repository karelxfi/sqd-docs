...
```
https://v2.archive.subsquid.io/network/shiden-substrate
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/shiden-substrate")
...
Get started indexing Shiden data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/shiden-substrate/schema"
>
