...
```
https://v2.archive.subsquid.io/network/tanssi-substrate
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/tanssi-substrate")
...
Get started indexing Tanssi data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/tanssi-substrate/schema"
>
