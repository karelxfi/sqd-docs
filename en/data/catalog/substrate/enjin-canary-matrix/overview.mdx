...
- **Network ID**: `enjin-canary-matrix`
...
```
https://v2.archive.subsquid.io/network/enjin-canary-matrix
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/enjin-canary-matrix")
...
Get started indexing Enjin Canary Matrix data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/enjin-canary-matrix/schema"
>
