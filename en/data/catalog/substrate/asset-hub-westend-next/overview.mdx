---
title: "Overview"
description: "Asset Hub Westend Next data indexing and API access"
---
...
- **Network ID**: `asset-hub-westend-next`
...
```
https://v2.archive.subsquid.io/network/asset-hub-westend-next
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/asset-hub-westend-next")
...
Get started indexing Asset Hub Westend Next data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/asset-hub-westend-next/schema"
>
