...
```
https://v2.archive.subsquid.io/network/data-avail
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/data-avail")
...
Get started indexing Data Avail (Avail Goldberg) data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/data-avail/schema"
>
