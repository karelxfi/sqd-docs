---
title: "Schema"
description: "Complete data schema and field reference for Aleph Zero Testnet"
---

# Aleph Zero Testnet Data Schema

Aleph Zero Testnet datasets provide comprehensive on-chain data indexed and queryable through the Subsquid Network.
