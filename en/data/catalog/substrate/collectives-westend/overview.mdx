...
- **Network ID**: `collectives-westend`
...
```
https://v2.archive.subsquid.io/network/collectives-westend
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/collectives-westend")
...
Get started indexing Collectives Westend data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/collectives-westend/schema"
>
