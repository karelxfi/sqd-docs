...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/vara-testnet")
...
Get started indexing Vara Testnet data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/vara-testnet/schema"
>
