...
```
https://v2.archive.subsquid.io/network/invarch-parachain
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/invarch-parachain")
...
Get started indexing Invarch Parachain data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/invarch-parachain/schema"
>
