...
```
https://v2.archive.subsquid.io/network/phala-testnet
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/phala-testnet")
...
Get started indexing Phala Testnet data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/phala-testnet/schema"
>
