...
- **Network ID**: `moonriver-substrate`
...
```
https://v2.archive.subsquid.io/network/moonriver-substrate
```
...
Get started indexing Moonriver data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/moonriver-substrate/schema"
>
