...
```
https://v2.archive.subsquid.io/network/rococo
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/rococo")
...
Get started indexing Rococo data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/rococo/schema"
>
