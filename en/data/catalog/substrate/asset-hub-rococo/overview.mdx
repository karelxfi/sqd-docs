...
```
https://v2.archive.subsquid.io/network/asset-hub-rococo
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/asset-hub-rococo")
...
Get started indexing Asset Hub Rococo data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/asset-hub-rococo/schema"
>
