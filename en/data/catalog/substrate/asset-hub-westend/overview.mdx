...
```
https://v2.archive.subsquid.io/network/asset-hub-westend
```
...
Get started indexing Asset Hub Westend data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/asset-hub-westend/schema"
>
