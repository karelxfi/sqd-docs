---
title: "Schema"
description: "Complete data schema and field reference for Bridge Hub Kusama"
---

# Bridge Hub Kusama Data Schema

Bridge Hub Kusama datasets provide comprehensive on-chain data indexed and queryable through the Subsquid Network.
