...
```
https://v2.archive.subsquid.io/network/bridge-hub-kusama
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/bridge-hub-kusama")
...
Get started indexing Bridge Hub Kusama data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/bridge-hub-kusama/schema"
>
