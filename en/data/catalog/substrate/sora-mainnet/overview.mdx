...
```
https://v2.archive.subsquid.io/network/sora-mainnet
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/sora-mainnet")
...
Get started indexing Sora data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/sora-mainnet/schema"
>
