...
```
https://v2.archive.subsquid.io/network/enjin-relay
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/enjin-relay")
...
Get started indexing Enjin Relay data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/enjin-relay/schema"
>
