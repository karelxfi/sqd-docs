---
title: "Overview"
description: "Eden data indexing and API access"
---
...
```
https://v2.archive.subsquid.io/network/eden
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/eden")
...
Get started indexing Eden data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/eden/schema"
>
