...
```
https://v2.archive.subsquid.io/network/bittensor-testnet
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/bittensor-testnet")
...
Get started indexing Bittensor Testnet data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/bittensor-testnet/schema"
>
