...
```
https://v2.archive.subsquid.io/network/zkverify-testnet
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/zkverify-testnet")
...
Get started indexing zkVerify Testnet data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/zkverify-testnet/schema"
>
