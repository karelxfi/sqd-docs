...
- **Network ID**: `peaq-mainnet-substrate`
...
```
https://v2.archive.subsquid.io/network/peaq-mainnet-substrate
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/peaq-mainnet-substrate")
...
Get started indexing Peaq data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/peaq-mainnet-substrate/schema"
>
