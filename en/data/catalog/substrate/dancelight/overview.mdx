...
```
https://v2.archive.subsquid.io/network/dancelight
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/dancelight")
...
Get started indexing Dancelight data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/dancelight/schema"
>
