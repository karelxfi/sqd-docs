...
```
https://v2.archive.subsquid.io/network/picasso
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/picasso")
...
Get started indexing Picasso data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/picasso/schema"
>
