---
title: "Schema"
description: "Complete data schema and field reference for Asset Hub Polkadot (\*)"
---

# Asset Hub Polkadot (\*) Data Schema

Asset Hub Polkadot (\*) datasets provide comprehensive on-chain data indexed and queryable through the Subsquid Network.
