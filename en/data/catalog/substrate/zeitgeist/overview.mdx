...
```
https://v2.archive.subsquid.io/network/zeitgeist
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/zeitgeist")
...
Get started indexing Zeitgeist data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/zeitgeist/schema"
>
