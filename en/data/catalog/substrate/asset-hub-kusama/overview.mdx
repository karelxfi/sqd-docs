...
```
https://v2.archive.subsquid.io/network/asset-hub-kusama
```
...
Get started indexing Asset Hub Kusama (\*) data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/asset-hub-kusama/schema"
>
