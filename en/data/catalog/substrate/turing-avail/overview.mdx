...
```
https://v2.archive.subsquid.io/network/turing-avail
```
...
Get started indexing Turing Avail data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/turing-avail/schema"
>
