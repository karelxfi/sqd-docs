...
```
https://v2.archive.subsquid.io/network/clover
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/clover")
...
Get started indexing Clover data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/clover/schema"
>
