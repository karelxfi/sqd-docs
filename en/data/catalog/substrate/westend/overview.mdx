...
```
https://v2.archive.subsquid.io/network/westend
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/westend")
...
Get started indexing Westend data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/westend/schema"
>
