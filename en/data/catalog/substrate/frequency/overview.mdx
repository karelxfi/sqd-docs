...
```
https://v2.archive.subsquid.io/network/frequency
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/frequency")
...
Get started indexing Frequency data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/frequency/schema"
>
