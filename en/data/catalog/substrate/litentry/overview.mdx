...
```
https://v2.archive.subsquid.io/network/litentry
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/litentry")
...
Get started indexing Litentry data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/litentry/schema"
>
