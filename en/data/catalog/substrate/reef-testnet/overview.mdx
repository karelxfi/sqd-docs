...
```
https://v2.archive.subsquid.io/network/reef-testnet
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/reef-testnet")
...
Get started indexing Reef Testnet data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/reef-testnet/schema"
>
