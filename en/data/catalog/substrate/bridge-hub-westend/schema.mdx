---
title: "Schema"
description: "Complete data schema and field reference for Bridge Hub Westend"
---

# Bridge Hub Westend Data Schema

Bridge Hub Westend datasets provide comprehensive on-chain data indexed and queryable through the Subsquid Network.
