...
```
https://v2.archive.subsquid.io/network/bridge-hub-westend
```
...
Get started indexing Bridge Hub Westend data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/bridge-hub-westend/schema"
>
