...
```
https://v2.archive.subsquid.io/network/moonbeam
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/moonbeam")
...
Get started indexing Moonbeam data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/moonbeam/schema"
>
