...
- **Network ID**: `subsocial-parachain`
...
```
https://v2.archive.subsquid.io/network/subsocial-parachain
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/subsocial-parachain")
...
Get started indexing Subsocial Parachain data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/subsocial-parachain/schema"
>
