...
```
https://v2.archive.subsquid.io/network/reef
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/reef")
...
Get started indexing Reef data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/reef/schema"
>
