...
```
https://v2.archive.subsquid.io/network/karura
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/karura")
...
Get started indexing Karura data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/karura/schema"
>
