...
- **Network ID**: `collectives-polkadot`
...
```
https://v2.archive.subsquid.io/network/collectives-polkadot
```
...
Get started indexing Collectives Polkadot data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/collectives-polkadot/schema"
>
