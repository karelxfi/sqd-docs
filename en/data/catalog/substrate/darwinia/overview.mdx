...
```
https://v2.archive.subsquid.io/network/darwinia
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/darwinia")
...
Get started indexing Darwinia data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/darwinia/schema"
>
