...
```
https://v2.archive.subsquid.io/network/pendulum
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/pendulum")
...
Get started indexing Pendulum data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/pendulum/schema"
>
