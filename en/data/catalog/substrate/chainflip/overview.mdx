---
title: "Overview"
description: "Chainfliip data indexing and API access"
---
...
```
https://v2.archive.subsquid.io/network/chainflip
```
...
const processor = new SubstrateBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/chainflip")
...
Get started indexing Chainfliip data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/substrate/chainflip/schema"
>
