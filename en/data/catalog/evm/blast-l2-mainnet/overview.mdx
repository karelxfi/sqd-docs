...
```
https://portal.sqd.dev/datasets/blast-l2-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/blast-l2-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/blast-l2-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/blast-l2-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/blast-l2-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/blast-l2-mainnet")
...
Get started indexing Blast L2 data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/blast-l2-mainnet/schema"
>
