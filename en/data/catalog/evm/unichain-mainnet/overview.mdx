...
```
https://portal.sqd.dev/datasets/unichain-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/unichain-mainnet/stream' \
...
url = "https://portal.sqd.dev/datasets/unichain-mainnet/stream"
...
Get started indexing Unichain Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/unichain-mainnet/schema"
>
