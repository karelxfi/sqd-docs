...
```
https://portal.sqd.dev/datasets/bob-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/bob-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/bob-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/bob-sepolia/stream"
...
```
https://v2.archive.subsquid.io/network/bob-sepolia
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/bob-sepolia")
...
Get started indexing BOB Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/bob-sepolia/schema"
>
