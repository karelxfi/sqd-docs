...
- **Network ID**: `bittensor-mainnet-evm`
...
```
https://portal.sqd.dev/datasets/bittensor-mainnet-evm
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/bittensor-mainnet-evm/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/bittensor-mainnet-evm",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/bittensor-mainnet-evm/stream"
...
```
https://v2.archive.subsquid.io/network/bittensor-mainnet-evm
```
...
Get started indexing Bittensor Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/bittensor-mainnet-evm/schema"
>
