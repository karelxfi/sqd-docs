...
```
https://portal.sqd.dev/datasets/dogechain-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/dogechain-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/dogechain-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/dogechain-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/dogechain-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/dogechain-testnet")
...
Get started indexing Dogechain Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/dogechain-testnet/schema"
>
