...
```
https://portal.sqd.dev/datasets/celo-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/celo-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/celo-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/celo-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/celo-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/celo-mainnet")
...
Get started indexing Celo Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/celo-mainnet/schema"
>
