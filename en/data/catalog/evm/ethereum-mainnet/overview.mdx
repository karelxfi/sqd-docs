...
Get started indexing Ethereum data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/ethereum-mainnet/schema"
>
  See complete field definitions for blocks, transactions, logs, traces, and
  state diffs
</Card>
