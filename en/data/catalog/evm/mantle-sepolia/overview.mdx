...
```
https://portal.sqd.dev/datasets/mantle-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/mantle-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/mantle-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/mantle-sepolia/stream"
...
```
https://v2.archive.subsquid.io/network/mantle-sepolia
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/mantle-sepolia")
...
Get started indexing Mantle Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/mantle-sepolia/schema"
>
