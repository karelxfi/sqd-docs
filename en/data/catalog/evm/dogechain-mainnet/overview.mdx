...
```
https://portal.sqd.dev/datasets/dogechain-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/dogechain-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/dogechain-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/dogechain-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/dogechain-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/dogechain-mainnet")
...
Get started indexing Dogechain data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/dogechain-mainnet/schema"
>
