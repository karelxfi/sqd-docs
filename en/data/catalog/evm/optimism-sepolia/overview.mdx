...
```
https://portal.sqd.dev/datasets/optimism-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/optimism-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/optimism-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/optimism-sepolia/stream"
...
Get started indexing Optimism Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/optimism-sepolia/schema"
>
