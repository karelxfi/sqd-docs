...
```
https://portal.sqd.dev/datasets/sonic-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/sonic-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/sonic-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/sonic-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/sonic-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/sonic-testnet")
...
Get started indexing Sonic Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/sonic-testnet/schema"
>
