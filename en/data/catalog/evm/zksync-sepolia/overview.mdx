...
```
https://portal.sqd.dev/datasets/zksync-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/zksync-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/zksync-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/zksync-sepolia/stream"
...
```
https://v2.archive.subsquid.io/network/zksync-sepolia
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/zksync-sepolia")
...
Get started indexing zkSync Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/zksync-sepolia/schema"
>
