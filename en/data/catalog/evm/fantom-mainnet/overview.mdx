...
```
https://portal.sqd.dev/datasets/fantom-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/fantom-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/fantom-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/fantom-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/fantom-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/fantom-mainnet")
...
Get started indexing Fantom data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/fantom-mainnet/schema"
>
