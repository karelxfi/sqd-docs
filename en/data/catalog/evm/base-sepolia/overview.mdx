...
```
https://portal.sqd.dev/datasets/base-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/base-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/base-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/base-sepolia/stream"
...
Get started indexing Base Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/base-sepolia/schema"
>
