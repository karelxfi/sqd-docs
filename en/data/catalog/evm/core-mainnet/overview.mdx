...
```
https://portal.sqd.dev/datasets/core-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/core-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/core-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/core-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/core-mainnet
```
...
Get started indexing Core Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/core-mainnet/schema"
>
