...
```
https://portal.sqd.dev/datasets/zksync-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/zksync-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/zksync-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/zksync-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/zksync-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/zksync-mainnet")
...
Get started indexing zkSync data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/zksync-mainnet/schema"
>
