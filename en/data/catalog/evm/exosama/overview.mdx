...
```
https://portal.sqd.dev/datasets/exosama
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/exosama/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/exosama",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/exosama/stream"
...
```
https://v2.archive.subsquid.io/network/exosama
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/exosama")
...
Get started indexing Exosama data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/exosama/schema"
>
