...
```
https://portal.sqd.dev/datasets/moonriver-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/moonriver-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/moonriver-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/moonriver-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/moonriver-mainnet
```
...
Get started indexing Moonriver data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/moonriver-mainnet/schema"
>
