...
```
https://portal.sqd.dev/datasets/xlayer-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/xlayer-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/xlayer-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/xlayer-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/xlayer-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/xlayer-testnet")
...
Get started indexing X Layer Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/xlayer-testnet/schema"
>
