...
```
https://portal.sqd.dev/datasets/binance-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/binance-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/binance-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/binance-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/binance-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/binance-testnet")
...
Get started indexing Binance Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/binance-testnet/schema"
>
