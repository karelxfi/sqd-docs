...
```
https://portal.sqd.dev/datasets/plume-legacy
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/plume-legacy/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/plume-legacy",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/plume-legacy/stream"
...
```
https://v2.archive.subsquid.io/network/plume-legacy
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/plume-legacy")
...
Get started indexing Plume Mainnet (Legacy) data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/plume-legacy/schema"
>
