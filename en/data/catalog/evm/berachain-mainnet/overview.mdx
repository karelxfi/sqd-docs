...
```
https://portal.sqd.dev/datasets/berachain-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/berachain-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/berachain-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/berachain-mainnet/stream"
...
Get started indexing Berachain Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/berachain-mainnet/schema"
>
