...
```
https://portal.sqd.dev/datasets/botanix-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/botanix-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/botanix-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/botanix-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/botanix-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/botanix-testnet")
...
Get started indexing Botanix Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/botanix-testnet/schema"
>
