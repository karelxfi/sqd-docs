...
```
https://portal.sqd.dev/datasets/moonbase-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/moonbase-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/moonbase-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/moonbase-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/moonbase-testnet
```
...
Get started indexing Moonbase Alpha data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/moonbase-testnet/schema"
>
