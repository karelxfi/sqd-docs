...
- **Network ID**: `soneium-minato-testnet`
...
```
https://portal.sqd.dev/datasets/soneium-minato-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/soneium-minato-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/soneium-minato-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/soneium-minato-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/soneium-minato-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/soneium-minato-testnet")
...
Get started indexing Soneium Minato Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/soneium-minato-testnet/schema"
>
