...
```
https://portal.sqd.dev/datasets/manta-pacific
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/manta-pacific/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/manta-pacific",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/manta-pacific/stream"
...
```
https://v2.archive.subsquid.io/network/manta-pacific
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/manta-pacific")
...
Get started indexing Manta Pacific data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/manta-pacific/schema"
>
