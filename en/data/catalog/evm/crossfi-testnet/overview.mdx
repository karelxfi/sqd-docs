...
```
https://portal.sqd.dev/datasets/crossfi-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/crossfi-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/crossfi-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/crossfi-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/crossfi-testnet
```
...
Get started indexing CrossFi Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/crossfi-testnet/schema"
>
