...
```
https://portal.sqd.dev/datasets/moonbeam-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/moonbeam-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/moonbeam-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/moonbeam-mainnet/stream"
...
Get started indexing Moonbeam data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/moonbeam-mainnet/schema"
>
