...
```
https://portal.sqd.dev/datasets/canto
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/canto/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/canto",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/canto/stream"
...
```
https://v2.archive.subsquid.io/network/canto
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/canto")
...
Get started indexing Canto data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/canto/schema"
>
