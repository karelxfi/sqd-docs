...
```
https://portal.sqd.dev/datasets/peaq-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/peaq-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/peaq-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/peaq-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/peaq-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/peaq-mainnet")
...
Get started indexing Peaq data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/peaq-mainnet/schema"
>
