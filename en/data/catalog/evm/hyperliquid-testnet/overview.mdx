...
```
https://portal.sqd.dev/datasets/hyperliquid-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/hyperliquid-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/hyperliquid-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/hyperliquid-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/hyperliquid-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/hyperliquid-testnet")
...
Get started indexing Hyperliquid Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/hyperliquid-testnet/schema"
>
