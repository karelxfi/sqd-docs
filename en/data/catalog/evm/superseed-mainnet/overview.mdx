...
```
https://portal.sqd.dev/datasets/superseed-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/superseed-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/superseed-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/superseed-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/superseed-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/superseed-mainnet")
...
Get started indexing Superseed Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/superseed-mainnet/schema"
>
