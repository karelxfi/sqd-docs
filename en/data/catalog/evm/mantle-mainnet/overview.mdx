...
```
https://portal.sqd.dev/datasets/mantle-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/mantle-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/mantle-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/mantle-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/mantle-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/mantle-mainnet")
...
Get started indexing Mantle data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/mantle-mainnet/schema"
>
