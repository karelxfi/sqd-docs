...
```
https://portal.sqd.dev/datasets/kyoto-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/kyoto-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/kyoto-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/kyoto-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/kyoto-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/kyoto-testnet")
...
Get started indexing Kyoto Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/kyoto-testnet/schema"
>
