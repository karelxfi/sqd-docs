...
```
https://portal.sqd.dev/datasets/ethereum-holesky
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/ethereum-holesky/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/ethereum-holesky",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/ethereum-holesky/stream"
...
```
https://v2.archive.subsquid.io/network/ethereum-holesky
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/ethereum-holesky")
...
Get started indexing Ethereum Holesky data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/ethereum-holesky/schema"
>
