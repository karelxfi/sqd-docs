...
```
https://portal.sqd.dev/datasets/avalanche-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/avalanche-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/avalanche-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/avalanche-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/avalanche-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/avalanche-testnet")
...
Get started indexing Avalanche Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/avalanche-testnet/schema"
>
