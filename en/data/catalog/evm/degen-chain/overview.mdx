...
```
https://portal.sqd.dev/datasets/degen-chain
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/degen-chain/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/degen-chain",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/degen-chain/stream"
...
```
https://v2.archive.subsquid.io/network/degen-chain
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/degen-chain")
...
Get started indexing Degen Chain data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/degen-chain/schema"
>
