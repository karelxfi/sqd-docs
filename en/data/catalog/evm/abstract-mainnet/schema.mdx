---
title: "Schema"
description: "Complete data schema and field reference for Abstract Mainnet"
---

# Abstract Mainnet Data Schema

Abstract Mainnet datasets provide comprehensive on-chain data including blocks, transactions, and logs (events), traces (internal transactions), and state changes. All data is indexed and queryable through Portal or v2 archives.
