...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/abstract-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/abstract-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/abstract-mainnet/stream"
...
Get started indexing Abstract Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/abstract-mainnet/schema"
>
  See complete field definitions for blocks, transactions, logs, traces, and state diffs
</Card>
