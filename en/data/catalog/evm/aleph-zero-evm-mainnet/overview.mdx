...
- **Network ID**: `aleph-zero-evm-mainnet`
...
```
https://portal.sqd.dev/datasets/aleph-zero-evm-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/aleph-zero-evm-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/aleph-zero-evm-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/aleph-zero-evm-mainnet/stream"
...
Get started indexing Aleph Zero EVM data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/aleph-zero-evm-mainnet/schema"
>
