...
```
https://portal.sqd.dev/datasets/arbitrum-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/arbitrum-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/arbitrum-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/arbitrum-sepolia/stream"
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/arbitrum-sepolia")
...
Get started indexing Arbitrum Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/arbitrum-sepolia/schema"
>
