...
```
https://portal.sqd.dev/datasets/metis-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/metis-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/metis-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/metis-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/metis-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/metis-mainnet")
...
Get started indexing Metis data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/metis-mainnet/schema"
>
