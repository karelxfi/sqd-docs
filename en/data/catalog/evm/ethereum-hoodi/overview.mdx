...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/ethereum-hoodi/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/ethereum-hoodi",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/ethereum-hoodi/stream"
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/ethereum-hoodi")
...
Get started indexing Ethereum Hoodi data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/ethereum-hoodi/schema"
>
