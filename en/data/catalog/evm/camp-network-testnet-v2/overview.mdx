...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/camp-network-testnet-v2/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/camp-network-testnet-v2",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/camp-network-testnet-v2/stream"
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/camp-network-testnet-v2")
...
Get started indexing Camp Network Testnet v2 data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/camp-network-testnet-v2/schema"
>
