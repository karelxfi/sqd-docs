...
```
https://portal.sqd.dev/datasets/hyperliquid-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/hyperliquid-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/hyperliquid-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/hyperliquid-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/hyperliquid-mainnet
```
...
Get started indexing Hyperliquid Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/hyperliquid-mainnet/schema"
>
