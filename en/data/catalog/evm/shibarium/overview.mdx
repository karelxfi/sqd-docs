...
```
https://portal.sqd.dev/datasets/shibarium
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/shibarium/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/shibarium",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/shibarium/stream"
...
```
https://v2.archive.subsquid.io/network/shibarium
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/shibarium")
...
Get started indexing Shibarium data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/shibarium/schema"
>
