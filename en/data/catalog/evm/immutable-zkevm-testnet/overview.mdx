...
- **Network ID**: `immutable-zkevm-testnet`
...
```
https://portal.sqd.dev/datasets/immutable-zkevm-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/immutable-zkevm-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/immutable-zkevm-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/immutable-zkevm-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/immutable-zkevm-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/immutable-zkevm-testnet")
...
Get started indexing Immutable zkEVM Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/immutable-zkevm-testnet/schema"
>
