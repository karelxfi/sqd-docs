...
```
https://portal.sqd.dev/datasets/b3-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/b3-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/b3-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/b3-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/b3-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/b3-mainnet")
...
Get started indexing B3 data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/b3-mainnet/schema"
>
