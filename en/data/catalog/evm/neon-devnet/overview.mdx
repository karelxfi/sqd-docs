...
```
https://portal.sqd.dev/datasets/neon-devnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/neon-devnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/neon-devnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/neon-devnet/stream"
...
```
https://v2.archive.subsquid.io/network/neon-devnet
```
...
Get started indexing Neon EVM Devnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/neon-devnet/schema"
>
