...
```
https://portal.sqd.dev/datasets/crossfi-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/crossfi-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/crossfi-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/crossfi-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/crossfi-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/crossfi-mainnet")
...
Get started indexing CrossFi Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/crossfi-mainnet/schema"
>
