---
title: "Schema"
description: "Complete data schema and field reference for Hedera Mainnet"
---

# Hedera Mainnet Data Schema

Hedera Mainnet datasets provide comprehensive on-chain data including blocks, transactions, and logs (events). All data is indexed and queryable through v2 archives.
