---
title: "Ethereum"
description: "Data catalog and endpoint information for Ethereum Mainnet"
---
  ...
  <Tab title="Portal (Recommended)">
    ...
    **Benefits**: 10-50x faster queries, decentralized (1,600+ nodes), 30x replication, real-time streaming
    ...
    const processor = new EvmBatchProcessor()
      .setGateway('https://portal.sqd.dev/datasets/ethereum-mainnet')
...
<CardGroup cols={3}>
  <Card title="Quick Start" icon="rocket" href="/en/sdk/pipes-sdk/quickstart">
    Build your first indexer with Ethereum
  </Card>
