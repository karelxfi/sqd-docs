...
```
https://portal.sqd.dev/datasets/cyber-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/cyber-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/cyber-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/cyber-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/cyber-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/cyber-mainnet")
...
Get started indexing Cyber Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/cyber-mainnet/schema"
>
