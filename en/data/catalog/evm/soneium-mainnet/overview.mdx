...
```
https://portal.sqd.dev/datasets/soneium-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/soneium-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/soneium-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/soneium-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/soneium-mainnet
```
...
Get started indexing Soneium Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/soneium-mainnet/schema"
>
