...
```
https://portal.sqd.dev/datasets/plume
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/plume/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/plume",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/plume/stream"
...
```
https://v2.archive.subsquid.io/network/plume
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/plume")
...
Get started indexing Plume Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/plume/schema"
>
