...
- **Network ID**: `gelato-arbitrum-blueberry`
...
```
https://portal.sqd.dev/datasets/gelato-arbitrum-blueberry
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/gelato-arbitrum-blueberry/stream' \
...
const queryBuilder = new EvmQueryBuilder()
  ...
  .addLog({
    request: { address: ["0xaf88d065e77c8cC2239327C5EDb3A432268e5831"] },
    range: { from: 10000000 },
  });

const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/gelato-arbitrum-blueberry",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/gelato-arbitrum-blueberry/stream"
...
func main() {
    ...
    payload := map[string]interface{}{
        ...
        "logs": []map[string]interface{}{
            {"address": []string{"0xaf88d065e77c8cC2239327C5EDb3A432268e5831"}},
        },
    }
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/gelato-arbitrum-blueberry")
...
Get started indexing Arbitrum Blueberry data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/gelato-arbitrum-blueberry/schema"
>
  See complete field definitions for blocks, transactions, logs, traces
</Card>
