...
```
https://portal.sqd.dev/datasets/memecore-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/memecore-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/memecore-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/memecore-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/memecore-mainnet
```
...
Get started indexing MemeCore Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/memecore-mainnet/schema"
>
