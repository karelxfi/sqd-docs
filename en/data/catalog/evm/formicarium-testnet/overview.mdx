...
- **Network ID**: `formicarium-testnet`
...
```
https://portal.sqd.dev/datasets/formicarium-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/formicarium-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/formicarium-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/formicarium-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/formicarium-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/formicarium-testnet")
...
Get started indexing MemeCore Testnet (Formicarium) data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/formicarium-testnet/schema"
>
