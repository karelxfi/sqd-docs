...
```
https://portal.sqd.dev/datasets/tanssi
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/tanssi/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/tanssi",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/tanssi/stream"
...
```
https://v2.archive.subsquid.io/network/tanssi
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/tanssi")
...
Get started indexing Tanssi data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/tanssi/schema"
>
