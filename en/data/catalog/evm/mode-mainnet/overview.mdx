...
```
https://portal.sqd.dev/datasets/mode-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/mode-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/mode-mainnet",
  query: queryBuilder,
});
```
...
```
https://v2.archive.subsquid.io/network/mode-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/mode-mainnet")
...
Get started indexing Mode Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/mode-mainnet/schema"
>
