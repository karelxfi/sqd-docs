...
```
https://portal.sqd.dev/datasets/merlin-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/merlin-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/merlin-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/merlin-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/merlin-mainnet
```
...
Get started indexing Merlin Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/merlin-mainnet/schema"
>
