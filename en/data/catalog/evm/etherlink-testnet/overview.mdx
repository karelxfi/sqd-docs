...
```
https://portal.sqd.dev/datasets/etherlink-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/etherlink-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/etherlink-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/etherlink-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/etherlink-testnet
```
...
Get started indexing Etherlink Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/etherlink-testnet/schema"
>
