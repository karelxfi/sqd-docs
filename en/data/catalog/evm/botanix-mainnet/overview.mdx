...
```
https://portal.sqd.dev/datasets/botanix-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/botanix-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/botanix-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/botanix-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/botanix-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/botanix-mainnet")
...
Get started indexing Botanix Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/botanix-mainnet/schema"
>
