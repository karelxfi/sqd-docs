...
```
https://portal.sqd.dev/datasets/abstract-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/abstract-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/abstract-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/abstract-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/abstract-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/abstract-testnet")
...
Get started indexing Abstract Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/abstract-testnet/schema"
>
