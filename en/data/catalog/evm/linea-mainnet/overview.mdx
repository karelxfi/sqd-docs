...
```
https://portal.sqd.dev/datasets/linea-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/linea-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/linea-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/linea-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/linea-mainnet
```
...
Get started indexing Linea data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/linea-mainnet/schema"
>
