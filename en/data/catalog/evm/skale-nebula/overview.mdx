...
```
https://portal.sqd.dev/datasets/skale-nebula
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/skale-nebula/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/skale-nebula",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/skale-nebula/stream"
...
```
https://v2.archive.subsquid.io/network/skale-nebula
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/skale-nebula")
...
Get started indexing Skale Nebula data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/skale-nebula/schema"
>
