...
```
https://portal.sqd.dev/datasets/rise-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/rise-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/rise-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/rise-sepolia/stream"
...
```
https://v2.archive.subsquid.io/network/rise-sepolia
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/rise-sepolia")
...
Get started indexing RISE Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/rise-sepolia/schema"
>
