...
```
https://portal.sqd.dev/datasets/gnosis-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/gnosis-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/gnosis-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/gnosis-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/gnosis-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/gnosis-mainnet")
...
Get started indexing Gnosis data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/gnosis-mainnet/schema"
>
