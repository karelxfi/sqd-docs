...
- **Network ID**: `celo-alfajores-testnet`
...
```
https://portal.sqd.dev/datasets/celo-alfajores-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/celo-alfajores-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/celo-alfajores-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/celo-alfajores-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/celo-alfajores-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/celo-alfajores-testnet")
...
Get started indexing Celo Testnet (Alfajores) data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/celo-alfajores-testnet/schema"
>
