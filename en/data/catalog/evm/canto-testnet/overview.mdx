...
```
https://portal.sqd.dev/datasets/canto-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/canto-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/canto-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/canto-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/canto-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/canto-testnet")
...
Get started indexing Canto Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/canto-testnet/schema"
>
