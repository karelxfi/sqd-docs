...
- **Network ID**: `manta-pacific-sepolia`
...
```
https://portal.sqd.dev/datasets/manta-pacific-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/manta-pacific-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/manta-pacific-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/manta-pacific-sepolia/stream"
...
```
https://v2.archive.subsquid.io/network/manta-pacific-sepolia
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/manta-pacific-sepolia")
...
Get started indexing Manta Pacific Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/manta-pacific-sepolia/schema"
>
