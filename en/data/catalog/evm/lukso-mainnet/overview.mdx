...
```
https://portal.sqd.dev/datasets/lukso-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/lukso-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/lukso-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/lukso-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/lukso-mainnet
```
...
Get started indexing Lukso Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/lukso-mainnet/schema"
>
