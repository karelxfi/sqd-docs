...
```
https://portal.sqd.dev/datasets/plume-devnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/plume-devnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/plume-devnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/plume-devnet/stream"
...
```
https://v2.archive.subsquid.io/network/plume-devnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/plume-devnet")
...
Get started indexing Plume Devnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/plume-devnet/schema"
>
