...
```
https://portal.sqd.dev/datasets/puppynet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/puppynet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/puppynet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/puppynet/stream"
...
```
https://v2.archive.subsquid.io/network/puppynet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/puppynet")
...
Get started indexing Puppynet (Shibarium's Testnet) data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/puppynet/schema"
>
