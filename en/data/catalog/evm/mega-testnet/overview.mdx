...
```
https://portal.sqd.dev/datasets/mega-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/mega-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/mega-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/mega-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/mega-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/mega-testnet")
...
Get started indexing Mega Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/mega-testnet/schema"
>
