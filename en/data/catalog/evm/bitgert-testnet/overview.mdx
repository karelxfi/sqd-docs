...
```
https://portal.sqd.dev/datasets/bitgert-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/bitgert-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/bitgert-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/bitgert-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/bitgert-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/bitgert-testnet")
...
Get started indexing Bitgert Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/bitgert-testnet/schema"
>
