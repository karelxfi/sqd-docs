...
```
https://portal.sqd.dev/datasets/bob-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/bob-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/bob-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/bob-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/bob-mainnet
```
...
Get started indexing BOB Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/bob-mainnet/schema"
>
