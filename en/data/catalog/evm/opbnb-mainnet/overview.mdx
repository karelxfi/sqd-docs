...
```
https://portal.sqd.dev/datasets/opbnb-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/opbnb-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/opbnb-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/opbnb-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/opbnb-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/opbnb-mainnet")
...
Get started indexing opBNB data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/opbnb-mainnet/schema"
>
