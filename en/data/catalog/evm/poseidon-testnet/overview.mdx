...
```
https://portal.sqd.dev/datasets/poseidon-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/poseidon-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/poseidon-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/poseidon-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/poseidon-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/poseidon-testnet")
...
Get started indexing Poseidon Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/poseidon-testnet/schema"
>
