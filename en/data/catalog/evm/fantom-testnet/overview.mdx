...
```
https://portal.sqd.dev/datasets/fantom-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/fantom-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/fantom-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/fantom-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/fantom-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/fantom-testnet")
...
Get started indexing Fantom Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/fantom-testnet/schema"
>
