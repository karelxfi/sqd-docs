...
```
https://portal.sqd.dev/datasets/scroll-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/scroll-mainnet/stream' \
...
url = "https://portal.sqd.dev/datasets/scroll-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/scroll-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/scroll-mainnet")
...
Get started indexing Scroll data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/scroll-mainnet/schema"
>
