...
```
https://portal.sqd.dev/datasets/sonic-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/sonic-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/sonic-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/sonic-mainnet/stream"
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/sonic-mainnet")
...
Get started indexing Sonic Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/sonic-mainnet/schema"
>
