...
```
https://portal.sqd.dev/datasets/b3-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/b3-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/b3-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/b3-sepolia/stream"
...
```
https://v2.archive.subsquid.io/network/b3-sepolia
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/b3-sepolia")
...
Get started indexing B3 Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/b3-sepolia/schema"
>
