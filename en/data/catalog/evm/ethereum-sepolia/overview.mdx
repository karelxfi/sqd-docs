...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/ethereum-sepolia/stream' \
...
url = "https://portal.sqd.dev/datasets/ethereum-sepolia/stream"
...
Get started indexing Ethereum Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/ethereum-sepolia/schema"
>
