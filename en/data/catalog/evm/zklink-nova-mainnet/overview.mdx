...
- **Network ID**: `zklink-nova-mainnet`
...
```
https://portal.sqd.dev/datasets/zklink-nova-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/zklink-nova-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/zklink-nova-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/zklink-nova-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/zklink-nova-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/zklink-nova-mainnet")
...
Get started indexing zkLink Nova Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/zklink-nova-mainnet/schema"
>
