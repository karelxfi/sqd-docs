...
```
https://portal.sqd.dev/datasets/superseed-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/superseed-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/superseed-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/superseed-sepolia/stream"
...
```
https://v2.archive.subsquid.io/network/superseed-sepolia
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/superseed-sepolia")
...
Get started indexing Superseed Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/superseed-sepolia/schema"
>
