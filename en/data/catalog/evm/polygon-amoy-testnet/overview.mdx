...
- **Network ID**: `polygon-amoy-testnet`
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/polygon-amoy-testnet/stream' \
...
url = "https://portal.sqd.dev/datasets/polygon-amoy-testnet/stream"
...
Get started indexing Polygon Amoy Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/polygon-amoy-testnet/schema"
>
