...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/binance-mainnet/stream' \
...
url = "https://portal.sqd.dev/datasets/binance-mainnet/stream"
...
Get started indexing Binance data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/binance-mainnet/schema"
>
