...
```
https://portal.sqd.dev/datasets/flare-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/flare-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/flare-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/flare-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/flare-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/flare-mainnet")
...
Get started indexing Flare data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/flare-mainnet/schema"
>
