...
```
https://portal.sqd.dev/datasets/opbnb-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/opbnb-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/opbnb-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/opbnb-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/opbnb-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/opbnb-testnet")
...
Get started indexing opBNB Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/opbnb-testnet/schema"
>
