...
```
https://portal.sqd.dev/datasets/shiden-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/shiden-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/shiden-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/shiden-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/shiden-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/shiden-mainnet")
...
Get started indexing Shiden data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/shiden-mainnet/schema"
>
