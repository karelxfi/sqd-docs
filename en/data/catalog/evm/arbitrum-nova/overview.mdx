...
```
https://portal.sqd.dev/datasets/arbitrum-nova
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/arbitrum-nova/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/arbitrum-nova",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/arbitrum-nova/stream"
...
```
https://v2.archive.subsquid.io/network/arbitrum-nova
```
...
Get started indexing Arbitrum Nova data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/arbitrum-nova/schema"
>
