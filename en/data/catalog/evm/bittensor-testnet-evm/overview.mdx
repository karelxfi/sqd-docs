...
- **Network ID**: `bittensor-testnet-evm`
...
```
https://portal.sqd.dev/datasets/bittensor-testnet-evm
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/bittensor-testnet-evm/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/bittensor-testnet-evm",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/bittensor-testnet-evm/stream"
...
```
https://v2.archive.subsquid.io/network/bittensor-testnet-evm
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/bittensor-testnet-evm")
...
Get started indexing Bittensor Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/bittensor-testnet-evm/schema"
>
