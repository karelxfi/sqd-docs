---
title: "Avalanche"
description: "Data catalog and endpoint information for Avalanche C-Chain"
---
...
<Tabs>
  <Tab title="Portal (Recommended)">
    ...
    ```
    https://portal.sqd.dev/datasets/avalanche-mainnet
    ```
    ...
    **Benefits**: 10-50x faster queries, decentralized (1,600+ nodes), 30x replication
    ...
    const processor = new EvmBatchProcessor()
      .setGateway('https://portal.sqd.dev/datasets/avalanche-mainnet')
  ...
  <Tab title="V2 Archive (Legacy)">
    ...
    ```
    https://v2.archive.subsquid.io/network/avalanche-mainnet
    ```
