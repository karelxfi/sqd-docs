...
```
https://portal.sqd.dev/datasets/scroll-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/scroll-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/scroll-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/scroll-sepolia/stream"
...
```
https://v2.archive.subsquid.io/network/scroll-sepolia
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/scroll-sepolia")
...
Get started indexing Scroll Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/scroll-sepolia/schema"
>
