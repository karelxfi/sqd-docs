...
```
https://portal.sqd.dev/datasets/dfk-chain
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/dfk-chain/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/dfk-chain",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/dfk-chain/stream"
...
```
https://v2.archive.subsquid.io/network/dfk-chain
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/dfk-chain")
...
Get started indexing DFK Chain data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/dfk-chain/schema"
>
