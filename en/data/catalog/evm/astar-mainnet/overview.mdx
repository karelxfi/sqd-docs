...
```
https://portal.sqd.dev/datasets/astar-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/astar-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/astar-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/astar-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/astar-mainnet
```
...
Get started indexing Astar data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/astar-mainnet/schema"
>
