...
Astar datasets provide comprehensive on-chain data including blocks, transactions, and logs (events). All data is indexed and queryable through Portal or v2 archives.
