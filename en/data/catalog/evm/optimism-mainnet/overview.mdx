...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/optimism-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/optimism-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/optimism-mainnet/stream"
...
Get started indexing Optimism data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/optimism-mainnet/schema"
>
