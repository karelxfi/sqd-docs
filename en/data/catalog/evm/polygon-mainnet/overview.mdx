...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/polygon-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/polygon-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/polygon-mainnet/stream"
...
Get started indexing Polygon data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/polygon-mainnet/schema"
>
