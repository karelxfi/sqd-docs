...
```
https://portal.sqd.dev/datasets/stratovm-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/stratovm-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/stratovm-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/stratovm-sepolia/stream"
...
```
https://v2.archive.subsquid.io/network/stratovm-sepolia
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/stratovm-sepolia")
...
Get started indexing StratoVM Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/stratovm-sepolia/schema"
>
