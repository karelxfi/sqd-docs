...
```
https://portal.sqd.dev/datasets/berachain-bartio
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/berachain-bartio/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/berachain-bartio",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/berachain-bartio/stream"
...
Get started indexing Berachain bArtio data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/berachain-bartio/schema"
>
