...
```
https://portal.sqd.dev/datasets/nakachain
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/nakachain/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/nakachain",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/nakachain/stream"
...
```
https://v2.archive.subsquid.io/network/nakachain
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/nakachain")
...
Get started indexing Naka Chain data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/nakachain/schema"
>
