...
```
https://portal.sqd.dev/datasets/monad-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/monad-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/monad-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/monad-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/monad-testnet
```
...
Get started indexing Monad Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/monad-testnet/schema"
>
