...
```
https://portal.sqd.dev/datasets/merlin-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/merlin-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/merlin-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/merlin-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/merlin-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/merlin-testnet")
...
Get started indexing Merlin Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/merlin-testnet/schema"
>
