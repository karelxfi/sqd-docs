...
```
https://portal.sqd.dev/datasets/galxe-gravity
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/galxe-gravity/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/galxe-gravity",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/galxe-gravity/stream"
...
```
https://v2.archive.subsquid.io/network/galxe-gravity
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/galxe-gravity")
...
Get started indexing Gravity data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/galxe-gravity/schema"
>
