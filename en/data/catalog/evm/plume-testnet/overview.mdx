...
```
https://portal.sqd.dev/datasets/plume-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/plume-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/plume-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/plume-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/plume-testnet
```
...
Get started indexing Plume Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/plume-testnet/schema"
>
