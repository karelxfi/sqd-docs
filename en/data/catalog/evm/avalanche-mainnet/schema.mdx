---
title: "Schema"
description: "Complete data schema and field reference for Avalanche"
---

# Avalanche Data Schema

Avalanche datasets provide comprehensive on-chain data including blocks, transactions, and logs (events), traces (internal transactions), and state changes. All data is indexed and queryable through Portal or v2 archives.
