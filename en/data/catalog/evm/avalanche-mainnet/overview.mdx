...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/avalanche-mainnet/stream' \
...
url = "https://portal.sqd.dev/datasets/avalanche-mainnet/stream"
...
Get started indexing Avalanche data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/avalanche-mainnet/schema"
>
