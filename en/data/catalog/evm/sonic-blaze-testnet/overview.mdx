...
- **Network ID**: `sonic-blaze-testnet`
...
```
https://portal.sqd.dev/datasets/sonic-blaze-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/sonic-blaze-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/sonic-blaze-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/sonic-blaze-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/sonic-blaze-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/sonic-blaze-testnet")
...
Get started indexing Sonic Blaze Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/sonic-blaze-testnet/schema"
>
