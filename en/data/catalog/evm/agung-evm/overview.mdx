...
```
https://portal.sqd.dev/datasets/agung-evm
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/agung-evm/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/agung-evm",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/agung-evm/stream"
...
```
https://v2.archive.subsquid.io/network/agung-evm
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/agung-evm")
...
Get started indexing Agung data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/agung-evm/schema"
>
