...
```
https://portal.sqd.dev/datasets/etherlink-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/etherlink-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/etherlink-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/etherlink-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/etherlink-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/etherlink-mainnet")
...
Get started indexing Etherlink Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/etherlink-mainnet/schema"
>
