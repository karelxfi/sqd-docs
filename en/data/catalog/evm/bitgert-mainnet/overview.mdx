...
```
https://portal.sqd.dev/datasets/bitgert-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/bitgert-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/bitgert-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/bitgert-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/bitgert-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/bitgert-mainnet")
...
Get started indexing Bitgert data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/bitgert-mainnet/schema"
>
