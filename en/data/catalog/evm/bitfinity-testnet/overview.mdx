...
```
https://portal.sqd.dev/datasets/bitfinity-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/bitfinity-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/bitfinity-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/bitfinity-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/bitfinity-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/bitfinity-testnet")
...
Get started indexing Bitfinity Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/bitfinity-testnet/schema"
>
