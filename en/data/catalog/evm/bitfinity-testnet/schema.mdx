---
title: "Schema"
description: "Complete data schema and field reference for Bitfinity Testnet"
---

# Bitfinity Testnet Data Schema

Bitfinity Testnet datasets provide comprehensive on-chain data including blocks, transactions, and logs (events). All data is indexed and queryable through Portal or v2 archives.
