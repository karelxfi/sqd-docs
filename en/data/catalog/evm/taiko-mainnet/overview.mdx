...
```
https://portal.sqd.dev/datasets/taiko-mainnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/taiko-mainnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/taiko-mainnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/taiko-mainnet/stream"
...
```
https://v2.archive.subsquid.io/network/taiko-mainnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/taiko-mainnet")
...
Get started indexing Taiko Mainnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/taiko-mainnet/schema"
>
