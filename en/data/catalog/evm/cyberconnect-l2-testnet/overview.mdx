...
- **Network ID**: `cyberconnect-l2-testnet`
...
```
https://portal.sqd.dev/datasets/cyberconnect-l2-testnet
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/cyberconnect-l2-testnet/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/cyberconnect-l2-testnet",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/cyberconnect-l2-testnet/stream"
...
```
https://v2.archive.subsquid.io/network/cyberconnect-l2-testnet
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/cyberconnect-l2-testnet")
...
Get started indexing Cyberconnect L2 Testnet data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/cyberconnect-l2-testnet/schema"
>
