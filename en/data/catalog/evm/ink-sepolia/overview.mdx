...
```
https://portal.sqd.dev/datasets/ink-sepolia
```
...
<CodeGroup>
```bash curl
curl -X POST 'https://portal.sqd.dev/datasets/ink-sepolia/stream' \
...
const source = createEvmPortalSource({
  portal: "https://portal.sqd.dev/datasets/ink-sepolia",
  query: queryBuilder,
});
```
...
url = "https://portal.sqd.dev/datasets/ink-sepolia/stream"
...
```
https://v2.archive.subsquid.io/network/ink-sepolia
```
...
const processor = new EvmBatchProcessor()
  .setGateway("https://v2.archive.subsquid.io/network/ink-sepolia")
...
Get started indexing Ink Sepolia data in minutes:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/evm/ink-sepolia/schema"
>
