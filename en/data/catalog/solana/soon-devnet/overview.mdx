...
```
https://v2.archive.subsquid.io/network/soon-devnet
```
...
const dataSource = new SolanaDataSource()
  .setGateway("https://v2.archive.subsquid.io/network/soon-devnet")
  .setBlockRange({ from: 0 });
```

## Quick Start

Get started indexing Soon Devnet data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/solana/soon-devnet/schema"
>
