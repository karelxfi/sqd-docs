...
```
https://v2.archive.subsquid.io/network/soon-testnet
```
...
const dataSource = new SolanaDataSource()
  .setGateway("https://v2.archive.subsquid.io/network/soon-testnet")
  .setBlockRange({ from: 0 });
```

## Quick Start

Get started indexing Soon Testnet data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/solana/soon-testnet/schema"
>
