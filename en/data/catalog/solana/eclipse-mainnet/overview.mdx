---
title: "Overview"
description: "Eclipse Mainnet data indexing and API access"
---
...
```
https://v2.archive.subsquid.io/network/eclipse-mainnet
```
...
const dataSource = new SolanaDataSource()
  .setGateway("https://v2.archive.subsquid.io/network/eclipse-mainnet")
  .setBlockRange({ from: 0 });
```

## Quick Start

Get started indexing Eclipse Mainnet data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/solana/eclipse-mainnet/schema"
>
