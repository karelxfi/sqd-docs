...
const dataSource = new SolanaDataSource()
  .setGateway("https://v2.archive.subsquid.io/network/eclipse-testnet")
  .setBlockRange({ from: 0 });
```

## Quick Start

Get started indexing Eclipse Testnet data:
...
<Card
  title="View Schema"
  icon="database"
  href="/en/data/catalog/solana/eclipse-testnet/schema"
>
