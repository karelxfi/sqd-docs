...
<Card title="Flexible Deployment Options" icon="server">
  ...
  [collocated](/en/cloud/reference/scale/#collocated) squids with full control
...
<Card title="Generous RPC Allowance" icon="network-wired">
  ...
  monthly, then just `$2` per additional million requests.
</Card>
...
<Tip>
  ...
  demo](https://calendly.com/d/yzj-48g-bf7/subsquid-demo) to discuss your
