...
<Tip>
If you used SQD Cloud before the slots and tags update, you may want to take a look at the [Changelog](/en/cloud/reference/deployments-two-changelog), including its [Backwards compatibility section](/en/cloud/reference/deployments-two-changelog/#backwards-compatibility).
</Tip>

Starting with `@subsquid/cli>=3.0.0` SQD Cloud is using a new deployment system based on the following concepts:

* **Slots:** Given a squid name and an [organization](/en/cloud/resources/organizations), slot name uniquely identifies a squid deployment.
...
<Info>
The functionality in this section mirrors the now-deprecated [production aliases](/en/cloud/resources/production-alias).
</Info>
...
- The detailed [changelog](/en/cloud/reference/deployments-two-changelog) that (for now) doubles as the reference documentation page. It describes the new system by comparing it to the old one that was based on versions and [production aliases](/en/cloud/resources/production-alias).

- If you used the old system or witnessed the migration of your organization, you may want to take a look at the [Backwards compatibility](/en/cloud/reference/deployments-two-changelog/#backwards-compatibility) section of the changelog.
