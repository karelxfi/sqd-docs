...
Profiles are described [here](/en/cloud/reference/pg/#scaling). Combine with the [cost of storage](/en/cloud/pricing/#storage) to get the full price of maintaining the database.

### Hibernated squids

For hibernated squids only the [storage costs](/en/cloud/pricing/#storage) are charged.
...
**A**: Use the [manifest-based deployments](/en/cloud/reference/manifest/) and [the profile reference](/en/cloud/reference/scale/).

**Q**: How can I use the provided RPC package? How do I set the rate limits for it?
 
**A**: Please look at the [RPC addon docs](/en/cloud/resources/rpc-proxy/).
