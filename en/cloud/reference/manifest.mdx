...
<Tip>
Cloud [secrets](/en/cloud/resources/env-variables/#secrets) of the squid's [organization](/en/cloud/resources/organizations) are exposed as the `secrets` context. You can set any variable defined in any of the `env:` sections mentioned below:
```yaml
env:
  RPC_ENDPOINT: "${{ secrets.FAST_RPC_ENDPOINT_URL }}"
```
See the [Environment variables](/en/cloud/resources/env-variables) page for more info.
</Tip>
