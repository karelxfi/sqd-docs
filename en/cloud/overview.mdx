...
<Note>
  ...
  [playground](/en/cloud/resources/organizations/#playgrounds). Playground squids
...
For squids that [write their data to PostgreSQL](sdk/resources/persisting-data/typeorm), use the [`postgres` addon](/en/cloud/reference/pg):
...
If your squid [uses a dedicated Hasura instance](sdk/resources/serving-graphql/#hasura), configure the [`hasura` addon](/en/cloud/reference/hasura) to provision it.
