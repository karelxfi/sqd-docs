...
- **Reduced reliance on centralized services:**
  ...
  - You can [query the network without relying on any centralized services](/en/portal/self-hosting). You can also use the public portal ran by the SQD team to just try it out.
...
- If you want to use a private portal:
  ...
  - [set it up](/en/portal/self-hosting)
  - get your portal's [dataset-specific API URL](/en/portal/self-hosting#using-your-portal) for the network you're interested in
