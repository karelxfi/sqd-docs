...
<Info>
  By delegating you're committing your tokens for a period of 50000 Ethereum
  blocks (a bit less than seven days) + the time until the end of the current
  [epoch](subsquid-network/faq/#epoch) (20 minutes or less). Withdrawal will not
...
4. Click the "Undelegate" button. You should see a form like this one:
   ...
   <Info>
     An inactive "Undelegate" button likely indicates the delegation lockup
     period still haven't passed.
   </Info>
