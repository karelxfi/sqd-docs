...
**Indexer Hosting** - [SQD Cloud](cloud) includes free unlimited access to a dedicated SQD Portal. You only pay for computational resources (CPUs, SSD space, etc.). View our [competitive pricing](cloud/pricing).
