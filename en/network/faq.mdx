...
1. **Run a worker node** - [Set up a worker](subsquid-network/participate/worker) to contribute storage and compute resources to the network and earn `SQD` tokens as rewards
2. **Delegate tokens** - [Delegate your `SQD` tokens](subsquid-network/participate/delegate) to high-performing workers and earn a share of their rewards
...
<Info>
  ...
  guide](subsquid-network/participate/worker) for detailed instructions.
</Info>
...
**Delegation** - [Delegate SQD tokens](subsquid-network/participate/delegate) to reliable workers and earn a percentage of their rewards.
