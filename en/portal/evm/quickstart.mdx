...
<CardGroup cols={2}>
<Card title="Query Event Logs" icon="file-lines" href="/en/portal/evm/use-portal/query-logs">
...
<Card
  ...
  href="/en/portal/evm/use-portal/query-transactions"
>
...
<Card
  ...
  icon="image"
  href="/en/portal/evm/use-portal/nft-transfers"
>
  Index NFT collection activity
</Card>

<Card title="Index DEX Swaps" icon="repeat" href="/en/portal/evm/use-portal/dex-swaps">
  Build DEX analytics
</Card>
</CardGroup>
...
<Card
  ...
  icon="code"
  href="/en/portal/evm/use-portal/query-logs"
>
