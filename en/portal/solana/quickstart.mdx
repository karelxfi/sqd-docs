...
Let's query the last 50 slots from Solana mainnet. Copy and paste this command:
...
```typescript
{
  ...
  "fromBlock": 280000000,         // Starting slot number (inclusive, field name: fromBlock)
  "toBlock": 280000003,           // Ending slot number (inclusive, field name: toBlock)
...
Track instructions from the Orca Whirlpool program:
