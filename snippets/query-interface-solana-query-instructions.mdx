export const QueryInterfaceSolanaQueryInstructions = () => {
  const useCasesConfig = [
    {
      id: "whirlpool-instructions",
      name: "Query Orca Whirlpool instructions",
  ...
  const [useCase, setUseCase] = useState("whirlpool-instructions");
